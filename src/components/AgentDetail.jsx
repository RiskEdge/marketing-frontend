			...
			<div className='flex gap-6'>
				...
				<div className='flex justify-between'>
					<button
						...
						{editMode ? (
							<span className='flex flex-col text-xs gap-1 items-center justify-center'>
								<ImCross className='text-xl text-red-600' /> Cancel{' '}
							</span>
						) : (
							<span className='flex  gap-2 text-gray-800 items-center justify-center'>
